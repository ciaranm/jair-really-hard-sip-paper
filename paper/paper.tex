...
3SAT problems---compare, for example, Figure~1 of \citeA{DBLP:journals/cacm/Leyton-BrownHHX14}. In
...
implementation of \citeA{DBLP:journals/cor/SegundoRJ11}'s bit-parallel maximum clique algorithm
...
a way of avoiding this. Similarly, \citeA{DBLP:journals/pvldb/ZhaoH10} argue that ``the graph query
...
returns a special subset of graphs which match a query, \citeA{DBLP:journals/tkde/ZhengLZHZ16}
...
\citeA{DBLP:journals/www/PengZ0LZ16} state that ``obviously, it is impossible to employ some
subgraph isomorphism algorithm, such as Ullmann or VF2'', and argue that ``in order to speed up
query processing'', they need to create indices.  And \citeA{DBLP:conf/isda/AzaouziR16} argue that
...
More recently, \citeA{DBLP:journals/pvldb/YuanMG13} continue a line of supergraph search work, again
...
\citeA{DBLP:conf/edbt/KatsarouNT17}'s second claim is that ``different
...
\citeA{DBLP:conf/edbt/KatsarouNT17}'s technique is due to the ease of sometimes getting better
