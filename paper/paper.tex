...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}
        \matrix {
            ...
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-satisfiable-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-satisfiable-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-satisfiable-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Glasgow}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-nodes-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize LAD}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-nodes-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize VF2}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-nodes-30.pdf}}; \\
        };
    \end{tikzpicture}
...
\begin{figure}[p]
    ...
    \begin{tikzpicture}
        \matrix {
            ...
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Satisfiable?}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-satisfiable-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Glasgow}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-nodes-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize LAD}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-induced-nodes-30.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize VF2}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-induced-nodes-30.pdf}}; \\
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Constrainedness}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-kappa-30.pdf}}; \\
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Complement?}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-10.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-14.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-15.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-16.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-20.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-induced-which-30.pdf}}; \\
        };
    \end{tikzpicture}
