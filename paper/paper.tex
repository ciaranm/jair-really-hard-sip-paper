...
\begin{figure}[tb]
    ...
    \begin{tikzpicture}[every node/.style={inner sep=0pt, outer sep=0pt}]
        \matrix {
            \node [anchor=center] {}; &
            \node [anchor=center] {\scriptsize $\mathcal{G}(10, x){\rightarrowtail}\mathcal{G}(150, y)$}; &
            \node [anchor=center] {\scriptsize $\mathcal{G}(20, x){\rightarrowtail}\mathcal{G}(150, y)$}; &
            \node [anchor=center] {\scriptsize $\mathcal{G}(30, x){\rightarrowtail}\mathcal{G}(150, y)$}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Satisfiable?}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-satisfiable-10-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-satisfiable-20-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-satisfiable-30-150.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize Glasgow}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-nodes-10-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-nodes-20-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-non-induced-kr-nodes-30-150.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize LAD}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-kr-nodes-10-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-kr-nodes-20-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-lad-non-induced-kr-nodes-30-150.pdf}}; &
            \\
            \node [anchor=center] [rotate=90] {\scriptsize VF2}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-kr-nodes-10-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-kr-nodes-20-150.pdf}}; &
            \node [anchor=center] {\includegraphics*{gen-graph-vf2-non-induced-kr-nodes-30-150.pdf}}; &
            \\
        };
    \end{tikzpicture}
...
By $\mathcal{G}(n, k)$ we mean a random graph with $k$ vertices, each of which has degree $k$. In
\cref{figure:kr} we recreate \cref{figure:non-induced}, using the NetworkX implementation
\citep{NetworkX} of the \citet{DBLP:journals/cpc/StegerW99} algorithm to generate regular graphs.
The $x$-axes range from degree 0 to degree $n - 1$, and the y-axes range from degree 0 to degree
149.

?? Text describing these results.
...
\begin{figure}[t]
    \begin{tikzpicture}[every node/.style={inner sep=0pt, outer sep=0pt}]
        \matrix {
            ...
            \node [anchor=center] {\scriptsize 2 label}; &
            \node [anchor=center] {\scriptsize 3 labels}; &
