...
\citep{DBLP:journals/ai/Solnon10,DBLP:conf/cp/McCreeshP15} in certain cases. In
...
\citep{o:Gilbert59,o:ErdosR59}.\footnote{Note that elsewhere, this same name sometimes instead
...
\citep{DBLP:journals/constraints/ZampelliDS10}, neighbourhood difference constraints
\citep{DBLP:journals/ai/Solnon10}, and distances and paths
...
2018.} paper, \citet{DBLP:conf/sigmod/YanYH04} introduce an indexing system
...
\begin{itemize}
    ...
    \item Domain-based heuristics are widely studied and well-understood
        \citep{DBLP:conf/cp/GentMPSW96}, and unlike VF2's adjacency branching rules, provide
...
\citet{DBLP:conf/lion/KotthoffMS16}, suggest that the real-world instances encountered so far are
